    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<form class="pt-form" id="send-family-details">
					...
					<div class="pt-input">
						<label class="small">
							<input type="checkbox" name="check" <?=(db_get("families", "public", $lg)?'':' checked')?>> <?=$lang['indexpage']['form']['view']?>
						</label>
					</div>
					<label><?=$lang['indexpage']['form']['vpass']['l']?></label>
					<div class="pt-input">
						<i class="fas fa-lock"></i>
						<input type="password" name="vpass" placeholder="<?=$lang['indexpage']['form']['vpass']['i']?>">
					</div>
					<?php endif; ?>
