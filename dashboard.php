								...
								<div class="media">
									...
									<div class="media-body">
										...
										<p>
											...
											<span><i class="fas fa-poll"></i> <?=db_rows("families WHERE author = '{$rs['id']}'")?> <?=$lang['dashboard']['surveys']?></span>
										</p>
									</div>
								</div>
							</li>
	...
	<?php elseif($pg == "users"): ?>
		...
		<div class="pt-title">
			...
			<div class="pt-options">
				<a href="#myModal" data-toggle="modal" class="btn bg-gy text-white"><i class="fas fa-plus"></i> <?=$lang['dash']['u_create']?></a>
			</div>
		</div>
		<div class="table-responsive">
		<table class="table">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
				<div class="form-row">
					<div class="col">
						<label><?=$lang['indexpage']['form']['fid']['l']?> <small class="text-danger">*</small></label>
						<input type="text" name="name" placeholder="<?=$lang['indexpage']['form']['fid']['i']?>">
					</div>
					<div class="col">
						<label><?=$lang['indexpage']['form']['pass']['l']?> <small class="text-danger">*</small></label>
						<input type="password" name="pass" placeholder="<?=$lang['indexpage']['form']['pass']['i']?>">
					</div>
				</div>

				<div class="form-groups">
					<label><?=$lang['indexpage']['form']['email']['l']?> <small class="text-danger">*</small></label>
	...
	<table class="table">
		<thead>
			<tr>
				...
				<th scope="col" class="text-center"><?=$lang['dash']['created_at']?></th>
			</tr>
		</thead>
		<tbody>
			<?php
